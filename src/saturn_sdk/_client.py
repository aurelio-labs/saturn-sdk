...
class SaturnSDK(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous saturn-sdk client instance."""
        if base_url is None:
            base_url = os.environ.get("SATURN_SDK_BASE_URL")
        if base_url is None:
            base_url = f"https://api.aurelio.ai"
...
class AsyncSaturnSDK(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async saturn-sdk client instance."""
        if base_url is None:
            base_url = os.environ.get("SATURN_SDK_BASE_URL")
        if base_url is None:
            base_url = f"https://api.aurelio.ai"
